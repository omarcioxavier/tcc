    ...
    public partial class First : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        clienteCategoriaID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.clienteID)
                .ForeignKey("dbo.clienteCategoria", t => t.clienteCategoriaID, cascadeDelete: false)
                .Index(t => t.clienteCategoriaID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        clienteEnderecoID = c.Int(nullable: false, identity: true),
                        clienteID = c.Int(nullable: false),
                        enderecoID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.clienteEnderecoID)
